...
function AccordionCategory({ categorys }) {
  return (
    <Accordion boxShadow="xl" borderRadius="base" allowToggle>
      <SubAccordionCategory
        category={categorys[0]}
        subCategorys={["Notebooks"]}
      ></SubAccordionCategory>
      <SubAccordionCategory
        category={categorys[1]}
        subCategorys={["Consolas"]}
      ></SubAccordionCategory>
      <SubAccordionCategory
      ...
      <SubAccordionCategory
        ...
        subCategorys={["Mothers Amd", "Mothers Intel"]}
      ></SubAccordionCategory>
      <SubAccordionCategory
        category={categorys[4]}
        subCategorys={["Memorias", "Memorias sodimm"]}
      ></SubAccordionCategory>
      <SubAccordionCategory
      ...
      <SubAccordionCategory
        ...
        subCategorys={["Placas de video Gforce", "Placas de video Radeon Amd"]}
      ></SubAccordionCategory>
      <SubAccordionCategory
      ...
      <SubAccordionCategory
        ...
        subCategorys={["Monitores y pantallas"]}
      ></SubAccordionCategory>
      <SubAccordionCategory
      ...
      <SubAccordionCategory
        ...
        subCategorys={["Sillas gamer"]}
      ></SubAccordionCategory>
      <SubAccordionCategory
        category={categorys[12]}
        subCategorys={["Volantes", "Simuladores de manejo"]}
      ></SubAccordionCategory>
      <SubAccordionCategory
        category={categorys[13]}
        subCategorys={["Webcam", "Tabletas digitalizadoras"]}
      ></SubAccordionCategory>
      <SubAccordionCategory
        category={categorys[14]}
        subCategorys={["Placas de red inalambricas", "Routers WiFi"]}
      ></SubAccordionCategory>
      <SubAccordionCategory
        category={categorys[15]}
        subCategorys={["Remeras"]}
      ></SubAccordionCategory>
      <SubAccordionCategory
        category={categorys[16]}
        subCategorys={["Estabilizadores"]}
      ></SubAccordionCategory>
      <SubAccordionCategory
